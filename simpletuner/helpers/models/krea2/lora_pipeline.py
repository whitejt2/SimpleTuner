...
from diffusers.utils import convert_unet_state_dict_to_peft, get_adapter_name, get_peft_kwargs
...
class Krea2LoraLoaderMixin(LoraBaseMixin):
    ...
    def load_lora_into_transformer(
        ...
        if not state_dict:
            ...
            raise ValueError(
                f"No KREA2 transformer LoRA keys were found. Expected one of: {supported}."
            )
        ...
        inject_adapter_in_model(lora_config, transformer, adapter_name=adapter_name, state_dict=state_dict, **peft_kwargs)
