...
from simpletuner.helpers.models.krea2.lora_pipeline import (
    _infer_krea2_lora_target_modules,
    _normalize_krea2_lora_state_dict,
)
...
class Krea2VendoredModelTests(unittest.TestCase):
    ...
    def test_lora_loader_accepts_comfyui_diffusion_model_prefix(self):
        ...
        self.assertEqual(
            normalized,
            {
                "transformer_blocks.1.attn.to_v.lora_A.weight": state_dict[
                    "diffusion_model.blocks.1.attn.wv.lora_A.weight"
                ],
                "transformer_blocks.1.attn.to_v.lora_B.weight": state_dict[
                    "diffusion_model.blocks.1.attn.wv.lora_B.weight"
                ],
            },
        )
